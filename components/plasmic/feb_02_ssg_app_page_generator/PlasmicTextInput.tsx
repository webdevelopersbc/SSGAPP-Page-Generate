...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: UtGW-dwzMz4l/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__arku9)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg___6SL4C)}
              role={"img"}
            />
          ),
