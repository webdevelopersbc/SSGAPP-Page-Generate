...
import sty from "./PlasmicEditable.module.css"; // plasmic-import: pg_wn98TVJJ5/css
    ...
    >
      <div
        className={classNames(
          ...
          "editableText",
          {
            [sty.freeBoxeditEnabled__cPgE1IUpn5]: hasVariant(
              $state,
              "editEnabled",
              "editEnabled"
            )
      ...
      <div
        className={classNames(
          ...
          "textEditor",
          {
            [sty.freeBoxeditEnabled___17WnwIUpn5]: hasVariant(
              $state,
              "editEnabled",
              "editEnabled"
            )
      ...
      >
        {(hasVariant($state, "editEnabled", "editEnabled") ? true : false)
          ? renderPlasmicSlot({
              defaultContents: (
                <TextInput
                  className={classNames("__wab_instance", sty.textInput__zIptv)}
                  endIcon={null}
                  startIcon={null}
                />
              ),
